...
function Checkout({ onClose }) {
  ...
  return (
    <section className="max-w-[800px] w-full mx-auto bg-white rounded-xl shadow-md">
      <div className='flex items-center justify-between text-lg py-3 px-4 border-b-2'>
        <p>Sign Call Record</p>
      ...
      <div className='p-5'>
        ...
        <div className="mt-5 mb-4 border border-black">
          ...
          <div className='p-3 space-y-1'>
            <p className="font-medium">Ibuprofen Tablets, USP 600mg</p>
        ...
        <div className="text-sm mb-2 flex items-start space-x-2">
          <input
            type="checkbox"
            className='mt-1'
        ...
        <div className="mb-4 space-y-3">
          ...
          <div className="flex items-center gap-2">
            <label htmlFor="receipt-toggle" className="text-sm font-semibold">Request Receipt?</label>
            <div
